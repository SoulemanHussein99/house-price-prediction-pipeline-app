...
# preparing data
#----------------
preprocess = ColumnTransformer(transformers=[('nume', StandardScaler(), feature_num), 
...
models = Pipeline([('preprocess', preprocess), ('model', model)])
...
result = pd.DataFrame([[oq, gla, gcs, tbs, hs, rs]], columns=[ 'OverallQual', 'GrLivArea', 'GarageCars', 'TotalBsmtSF','HouseStyle',  'RoofStyle',])
